...
class IdleGameScreen(
	...
	private val state: GameplayState,
) : ScreenAdapter() {
	...
	private val labelStyle =
		com.tbawor.ui.UiFactory
			.createLabelStyle(font, Color.WHITE)
	...
	private val clickButton =
		com.tbawor.ui.GreenButton(
			text = "Work (+$1)",
			disposables = disposables,
		)
	private val buyBuildingButton =
		com.tbawor.ui.GreenButton(
			text = "Buy Building",
			disposables = disposables,
		)
